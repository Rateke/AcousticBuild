...
// Âncoras da Home com o prefixo do site ("/" local, "/AcousticBuild/" no Pages).
    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        <div className={styles.grid}>
          ...
          {/* Coluna 2 - Navegação
              As âncoras levam o endereço da Home na frente porque o rodapé também
              aparece fora dela — sem isso o link não faz nada nas outras páginas. */}
          <div className={styles.col}>
            <h4 className={styles.colTitle}>Navegação</h4>
            <ul className={styles.colLinks}>
              <li><a href={`${HOME}#o-que-somos`}>O que somos</a></li>
